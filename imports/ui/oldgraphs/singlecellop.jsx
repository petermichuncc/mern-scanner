...
export default class SingleCellOp extends Component {
...
axios.get('/dataentriesWorkcentersGraphs',{
  params: {
...
this.setState({
  SelectFieldedOperator: "Lisa Edwards",
});
...
axios.get('/averagesingleworkcenter',{
  params: {
        workcenter:"1020",
       operator: "Lisa Edwards",
...
axios.get('/averagesingleworkcenter',{
  params: {
       ...
       operator: this.state.SelectFieldedOperator,
       start:date,
       end:this.state.maxDate
     }
 ...
 handleChangeWorkcenter = (workcenter, index) =>{
 console.log("This is the value SelectFielded"+ workcenter)
 ...
 handleChangeOperator = (SelectFieldedOperator, index) =>{
console.log("This is the value SelectFielded"+ SelectFieldedOperator)

//console.log("jquery SelectFielded text "+$(".department menuItem[value="+value+"]").text())
//console.log("This is the text "+event.target.name)
var operator=SelectFieldedOperator.toString()
console.log("This is the operator "+operator+"this is the workcenter "+this.state.workcenter)
...
*/
   ...
   this.setState({SelectFieldedOperator});
console.log("This is the SelectFielded operator state "+this.state.SelectFieldedOperator)
...
var titleFont='20px'
 ...
 var config = {
   ...
   title: {
       text: "Workcell average for "+this.state.SelectFieldedOperator+" vs permanent"
   },
    xAxis: {
...
<div className="center " >
  <AutoComplete
    ...
    />
    <AutoComplete
        floatingLabelText="Please enter a workcell"
        filter={AutoComplete.fuzzyFilter}
