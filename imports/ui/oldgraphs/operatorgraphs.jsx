...
export default class Operatorgraphs extends Component {
...
averages = () => {
    //console.log('this is:', this);
    setTimeout(function() {
      window.location.href = '/allopcenters';
  //FlowRouter.go('/allopcenters');
  //FlowRouter.reload();
}, 500);
  }
...
singleAverage = () => {
    //console.log('this is:', this);
    setTimeout(function() {
      window.location.href = '/singlecellop';
  //FlowRouter.go('/singlecellop');
  //FlowRouter.reload();
}, 500);
  }
  ...
  overallAverage = () => {
      //console.log('this is:', this);
      setTimeout(function() {
        window.location.href = '/averageopworkcells';
    //FlowRouter.go('/averageopworkcells');
    //FlowRouter.reload();
  }, 500);
    }
...
<h3 className="textblack" style={{color:"black"}} >Operator Graphs</h3>
</div>



    <RaisedButton label="Averages for all workcenters" className="buttonsize operator" primary={true} onClick={this.averages}/>
<br/>
         <br/>
         <RaisedButton label="Productivity average by workcenter" className="buttonsize workcell" primary={true} onClick={this.singleAverage}/>
           <br/>
                    <br/>
                    <RaisedButton label="Overall average of all workcenters" className="buttonsize workcell" primary={true} onClick={this.overallAverage}/>
                      <br/>
                               <br/>
