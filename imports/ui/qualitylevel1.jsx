...
export default class QualityLevel1 extends Component {
...
axios.get('/departmentAllMinutesLostQualityLevel1',{
  params: {
...
console.log("This is the department "+this.state.value)
   ...
   var qualityDefectNames=datatest[0]
   var shift1New=datatest[1]

   var shift2New=datatest[2]

   var shift3New=datatest[3]
...
var titleFont='20px'
 ...
 var config = {
  ...
  chart: {
     ...
     title: {
       margin: 70,
         text: 'Quality Level 1: '+department,
           style: {
                   fontWeight: 'bold',
                     color: 'black',
                     fontSize:titleFont
